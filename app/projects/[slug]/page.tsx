...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!project) return { title: "Projects | Nahid Reza" };
  return {
    title: `${project.frontmatter.title} | Project | Nahid Reza`,
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
              ...
              {frontmatter.live && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white text-black rounded-md font-medium hover:bg-gray-200 transition-colors text-sm shrink-0"
                >
